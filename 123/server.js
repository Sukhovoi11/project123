...
app.post('/send-feedback', (req, res) => {
    ...
    // Здесь можно добавить логику сохранения в базу данных или отправки на почту

    console.log(`Received feedback from ${email}: ${message}`);

    // Возвращаем пользователю страницу с подтверждением или другой обработкой
    return res.send('Thank you for your feedback!');
});

// Добавляем статический маршрут для страницы обратной связи
app.use('/feedback', express.static(path.join(__dirname, 'regist')));
